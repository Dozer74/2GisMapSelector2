...
namespace GisSelector
{
    ...
    {
        private static Grym pGrymCore;
        private static IBaseReference pBaseRef;
        private static IBaseViewThread pBaseView;
        ...
        private DataBase DeserializeDatabase(string path)
        {
            if (!File.Exists(path))
            {
                MessageBox.Show(Resources.BaseNotFoundMsg, "Предупреждение", MessageBoxButtons.OK,
        ...
        private readonly Settings ps = Settings.Default;
